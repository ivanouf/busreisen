...
public class Sortierverfahren {
	/**
	 * Disese Methode Sortiert die Daten in aufsteigender Reihenfolge.
	 * Es wird das Verfahren "SelectionSort" genutzt.
	 * @param daten
	 * 				Array von Strings
	 */
	...
	/**
	 * Disese Methode Sortiert die Daten in aufsteigender Reihenfolge.
	 * Es wird das Verfahren "BubbleSort" genutzt.
	 * 
	 * @param daten
	 * 				Array von Strings
	 */
	...
	/**
	 * Disese Methode Sortiert die Daten in aufsteigender Reihenfolge.
	 * Es wird das Verfahren "InsertSort" genutzt.
	 * 
	 * @param daten
	 * 				Array von Strings
	 */
	public static void insertionSort(int daten[]){
		/* void insertionSort(double datan[])
		 * 		Deklaration von i,j, hilfsVar
		 * 		wiederhole für i mit Anfangswert 1, Endwert LängeArray *(=10) und Schtittweite 1
		 * 			j=i
		 * 			hilfsVar=daten[i]
		 * 			solange (j>0) oder (daten[j-1]>hilfsVar)
		 * 					daten[j] = daten[j-1]
		 * 					j--                                     
		 * 			daten[j] = hilfsVar
		 */
